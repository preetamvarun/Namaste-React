...
const cloudinaryImg = 'https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/';

const RestaurantCard = ({cloudinaryImageId,name,cuisines,rating}) => {
    return (
        <div className="RestaurantCard">
            <img src= {cloudinaryImg + cloudinaryImageId} alt = 'burger'/>
            <p>{name}</p>
            <p>{cuisines.join(",")}</p>
            <p>{rating}STARS</p>
        </div>
